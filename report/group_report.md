...
| Reporting | metrics + quality + freshness | 2 báo cáo Markdown, delta tính bằng code | `data/reports/*.md` | Đăng (Bình làm thay) |
...
trên corpus thật cho thấy Crossref trả `subject` **rỗng 23/23 bản ghi**, nên `categories_joined =
"uncategorized"` ở mọi paper. Vì `qa.py` trả thẳng `metadata["categories_joined"]` cho loại câu này,

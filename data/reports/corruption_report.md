...
_Sinh tự động lúc 2026-08-06T09:29:07.376127+00:00 từ `data/results/*_metrics.json`, `data/quality/*.json` và `data/results/corruption_log.json`._
...
| `mean_judge_score` | 5 | 3.78 | 5 | -1.22 | 100% |

## 2. Data quality checks

| Check | Baseline | Corrupted | Repaired |
| --- | --- | --- | --- |
| `row_count_min` | xem `phase1_report.md` | PASS (`23`) | PASS (`23`) |
| `paper_id_not_null` | xem `phase1_report.md` | PASS (`0`) | PASS (`0`) |
| `paper_id_unique` | xem `phase1_report.md` | FAIL (`3`) | PASS (`0`) |
| `title_not_empty` | xem `phase1_report.md` | PASS (`0`) | PASS (`0`) |
| `summary_min_length` | xem `phase1_report.md` | FAIL (`5`) | PASS (`0`) |
| `freshness_age_days` | xem `phase1_report.md` | FAIL (`6`) | PASS (`0`) |
...
| --- | --- | --- |
| Trạng thái | Stale (stale_rows=6) | Fresh (stale_rows=0) |
| `max_age_days` | `975` | `175` |
| `latest_published` | `2026-07-03` | `2026-08-01` |
| `oldest_published` | `2023-12-05` | `2026-02-12` |
...
2. Chất lượng agent giảm ở 4 metric. Giảm mạnh nhất là `mean_judge_score`: 5 → 3.7826 (-1.2174).
